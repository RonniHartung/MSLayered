...
namespace MusicStoreUI.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Price,AlbumArtUrl,SongSampleUrl,ReleaseDate,ArtistId,GenreId")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Price,AlbumArtUrl,SongSampleUrl,ReleaseDate,ArtistId,GenreId")] Album album)
        {
            if (ModelState.IsValid)
            {
